    ...
    export default async function sendMessage(id, sender_id , receiver_id , message_type , content, chat_id){ 
        const query = `
    ...
    `;
        ...
        try{
            await conn.query(query,[id,sender_id, receiver_id, message_type, content, chat_id]);
